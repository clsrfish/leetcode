...
INSTANTIATE_TEST_SUITE_P(
    leetcode, LeetCodeSuite_39,
    testing::Values(std::make_tuple(std::vector<int>{2, 3, 6, 7}, 7, std::vector<std::vector<int>>{{2, 2, 3}, {7}}),
                    ...
                    std::make_tuple(std::vector<int>{1}, 1, std::vector<std::vector<int>>{{1}}),
                    std::make_tuple(std::vector<int>{1}, 2, std::vector<std::vector<int>>{{1, 1}})));
} // namespace